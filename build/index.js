...
if (process.env.MODE === "prod") {
  bot.telegram.setWebhook("".concat(process.env.URL, "/bot").concat(process.env.API_TOKEN));
  bot.startWebhook("/bot".concat(process.env.API_TOKEN), null, process.env.PORT);
} else {
  bot.launch();
}
