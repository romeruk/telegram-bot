                ...
                switch ((_context.prev = _context.next)) {
                  case 0:
                    ...
                    return _axios['default'].get(
                      ''
                        .concat(
                          process.env.OPEN_DOTA_BASE_API_URL,
                          '/heroStats?api_key='
                        )
                        .concat(process.env.OPEN_DOTA_KEY)
                    );

                  case 7:
                    heroes_stats = _context.sent;
                    data = heroes_stats.data.slice(
                      (page - 1) * dataCount,
                      page * dataCount
                    );
                      ...
                      return {
                        ...
                        input_message_content: {
                          message_text: '<b>\u041D\u0430\u0437\u0432\u0430 \u0433\u0435\u0440\u043E\u044F:</b> '
                            .concat(
                              hero.localized_name,
                              '\n<b>\u041E\u0441\u043D\u043E\u0432\u043D\u0438\u0439 \u0430\u0442\u0440\u0438\u0431\u0443\u0442:</b> '
                            )
                            .concat(
                              (0, _listheroeshelper.primary_attr)(
                                hero.primary_attr
                              ),
                            ...
                            .concat(
                              (0, _listheroeshelper.attack_type)(
                                hero.attack_type
                              ),
                              '\n<b>\u0411\u0430\u0437\u043E\u0432\u0430 \u0441\u0438\u043B\u0430:</b> '
                            )
                            ...
                            .concat(
                              hero.base_int,
                              '\n<b>\u0406\u0433\u0440\u0430\u0431\u0435\u043B\u044C\u043D\u0456 \u043F\u043E\u0437\u0438\u0446\u0456\u0457:</b> '
                            )
                            .concat(hero.roles.join()),
                          parse_mode: 'HTML',
                        },
